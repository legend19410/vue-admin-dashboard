        ...
        <div class="main-header-container container-fluid">
            ...
            <div class="header-content-right">
                ...
                <div class="header-element cart-dropdown">
                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <div v-if="cartList.length" class="p-3 empty-header-item border-top">
                            <div class="d-grid">
                                <router-link to="#" class="btn btn-primary">Proceed to checkout</router-link>
                            </div>
                        </div>
                        <div v-if="!cartList.length" class="p-5 empty-item">
                            <div class="text-center">
                                ...
                                <router-link to="#" class="btn btn-primary btn-wave btn-sm m-1" data-abc="true">continue shopping <i class="bi bi-arrow-right ms-1"></i></router-link>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul v-if="notificationList.length" class="list-unstyled mb-0" id="header-notification-scroll">
                            <li v-for="(item, key) in notificationList" :key=key class="dropdown-item">
                                <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-semibold"><router-link to="#" class="text-dark" v-html="item.title"></router-link></p>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile" style=""> 
                    <li><router-link class="dropdown-item d-flex" to="#"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</router-link></li> 
                    <li><router-link class="dropdown-item d-flex" to="#"><i class="ti ti-inbox fs-18 me-2 op-7"></i>Inbox <span class="badge bg-success-transparent ms-auto">25</span></router-link></li> 
                    <li><router-link class="dropdown-item d-flex border-block-end" to="#"><i class="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task Manager</router-link></li> 
                    <li><router-link class="dropdown-item d-flex" to="#"><i class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</router-link></li> 
                    ...
                    <li><router-link class="dropdown-item d-flex" to="#"><i class="ti ti-headset fs-18 me-2 op-7"></i>Support</router-link></li> 
                    <li><router-link class="dropdown-item d-flex"  to="#"><i class="ti ti-logout fs-18 me-2 op-7"></i>Log Out</router-link></li> 
                </ul> 
            </div>
                ...
                <div class="modal-body">
                  ...
                  <div class="my-4">
                    ...
                    <div class="p-2 border br-5 d-flex align-items-center text-muted mb-2 alert">
                      <router-link to="#"><span>Notifications</span></router-link>
                      <a class="ms-auto lh-1" href="javascript:void(0);" data-bs-dismiss="alert" aria-label="Close"><i class="fe fe-x text-muted"></i></a>
                    </div>
                    <div class="p-2 border br-5 d-flex align-items-center text-muted mb-2 alert">
                      <router-link to="#"><span>Alerts</span></router-link>
                      <a class="ms-auto lh-1" href="javascript:void(0);" data-bs-dismiss="alert" aria-label="Close"><i class="fe fe-x text-muted"></i></a>
                    </div>
                    <div class="p-2 border br-5 d-flex align-items-center text-muted mb-0 alert">
                      <router-link to="#"><span>Mail</span></router-link>
                      <a class="ms-auto lh-1" href="javascript:void(0);" data-bs-dismiss="alert" aria-label="Close"><i class="fe fe-x text-muted"></i></a>
                    </div>
                  </div>
                </div>
